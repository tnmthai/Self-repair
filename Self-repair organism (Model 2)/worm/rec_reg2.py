...
#           y.append(t[1])
#       print x,y
       Body,mid2=Worm.Body(5)
       Btissue=Body.extractdata(15)
       x,y=data(Htissue,Btissue,Ttissue)
       ax3.scatter(x, y)   
       
       ax3.set(xlabel='x', ylabel='y')
       ax3.set_title('a) Regenerating tissue - 2')
       ax3.set_xlim(9,41)
       ax3.set_ylim(-1,11)
       stemcells[1]=mid2
       x=[]
...
#draw waorm after repaired Fig 4  
       Body,mid2=Worm.Body(10)      
       Btissue=Body.extractdata(30)
       x,y=data(Htissue,Btissue,Ttissue)
       ax4.scatter(x, y)     
       ax4.set_xlim(9,41)
       ax4.set_ylim(-1,11)       
