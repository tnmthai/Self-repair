...
#draw damage worm Fig 1
       ...
       ax1.set_title('A. A portion of the body interior')
       ax1.set_xlim(-5,110)
       ax1.set_ylim(0,50)
...
# Repair
       ...
       seed1=[42,23]  
       worm.repair_head1(d0-15,seed1)
       seed2=[63,23] 
       worm.repair_tail1(d0-15,seed2)
...
#draw recover worm Fig 3
       ...
       seed3=[33,23]
       seed2=[69,23]
       worm.repair_body1(d0-8,seed3)
       worm.repair_head1(d0-8,seed3)
       worm.repair_tail1(d0-8,seed2)
...
# =============================================================================       
#draw recover worm Fig 4
       seed3=[28,23]
       seed2=[76,23]
       worm.repair_body1(d0-4,seed3)
       worm.repair_head1(d0-4,seed3)
       worm.repair_tail1(d0-4,seed2)
...
# Repair
       ...
       seed2=[83,23]
       seed1=[22,23]
       worm.repair_body1(d0,seed3)
       worm.repair_head1(d0,seed1)
       worm.repair_tail1(d0,seed2)
# =============================================================================       
#draw recover worm Fig 5
       Tissue=worm.extractdata(d0)
       x,y,z=data(Tissue)       
...
#=============================================================================       
       plt.savefig("case7b.jpg", dpi=400)
       plt.tight_layout()
       plt.show()
#=============================================================================       
# =============================================================================             
