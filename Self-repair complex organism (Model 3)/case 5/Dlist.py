...
#------------------------------------------------------------------------------
    ...
    def SendSCnet(self,sc):
        try:
            if sc.one.value !=0:
                sc.one.status=-1
                sc.one.value =0.9#+= sc.one.value*0.2
                print ('a',sc.one.data)
            if sc.two.value != 0:
                sc.two.status=-1
                sc.two.value =0.9#+= sc.two.value*0.2
                print ('b',sc.two.data)
            if sc.three.value != 0:
                sc.three.status=-1
                sc.three.value =0.9#+= sc.three.value*0.2
                print ('c',sc.three.data)
            if sc.four.value != 0:
                sc.four.status=-1
                sc.four.value =0.9#+=sc.four.value*0.2
