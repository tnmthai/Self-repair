...
#draw damage worm Fig 1
       ...
       ax1.set_title('A. Complex damage')
       ax1.set_xlim(-5,110)
       ax1.set_ylim(0,50)
...
# Repair
       ...
       print ('f2',damage,mid_head.data)
       worm.Repairc8c(mid_head,5,0.6)
...
#draw recover worm Fig 3
       # worm.Case8c(d0) 
       # damage, results, mid_head,mid_tail=worm.identifyPart(d0)
       print ('f3',damage,mid_head.two.data)
       worm.Repairc8c(mid_head.two,10,0.55)
...
#draw recover worm Fig 4
       # worm.Case8c(d0) 
       # damage, results, mid_head,mid_tail=worm.identifyPart(d0)
       print ('f4',damage,mid_head.two.data)
       worm.Repairc8c(mid_head.two,18,0.6)
