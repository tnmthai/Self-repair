...
### Damge case 2: 1 d-cell damage
    ...
    def extractgroup(self,d,g):
        ...
        return Tissue
    def restore(self,node,sc,v=0.05):
        node.value= v#sc.value
        node.status=None

    def SCRepair(self,sc,v=0.05):
...
#------------------------------------------------------------------------------
    ...
    def CheckSCNei(self,node):
        f=True
        if node.one!=None and node.one.value==0:
            f=False
        if node.two!=None and node.two.value==0:
            f=False
        if node.three!=None and node.three.value==0:
            f=False
        if node.four!=None and node.four.value==0:
            f=False
    ...
    def CheckLR(self,node):#check left - right DV direction
        f=True
    ...
    def SCNet(self,sc):
        try:
            if sc.one != None and sc.one.value ==0:
                sc.one.value = 0.9          
                return sc.one
            
            elif sc.two != None and sc.two.value == 0:
            ...
            elif sc.four != None and sc.four.value == 0:
                sc.four.value =0.9             
                return sc.four
        ...
        for d in range(1,d0):  #range(1,d0):
            ...
            for i in range(0,d+1):# range(0,d+1): #np.arange(0,0.5,d+1)
                ...
                if i==d:
                    ...
                    k = k - 1 
#---------------------------------------------------------------------------------------
    def Case6b(self,d): #a part damage
...
### body
    def repair_body(self,damage,d0): #repair
       self.Case6b(d0) 
       d1=106
       value=0.6
       seed=[23,23]
    ...
    def Repairc8(self,d,v=0.45):
        ...
        for i in range(30,d):
            ...
            while current:                                  
                if current.type=='s' and current.status==-1 and current.value!=0:
                    # current.value=value
                    self.SCRepair(current,v)
                    self.CheckSCNei(current)
                    newnode = self.SCNet(current)
                    self.SCRepair(newnode,v)
                    self.CheckSCNei(newnode)
                current = current.next
    ...
    def Case8c(self,d):
        ...
        for i in range(42,5*d-9):
            ...
            while current != None:
                ...
                current = current.next
                ind+=1
    def Repairc8c(self,damage,d0,v=0.5):
        d1=106
        value=v
        z=0
        self.SCRepair(damage,v)
    ...
    def SCLR(self,sc):
        try:
            if sc.two != None and sc.two.value == 0:
                sc.two.value =0.9 #sc.value                
                return sc.two
            elif sc.three != None and sc.three.value == 0:
                sc.three.value =0.9 #sc.value   sc.value               
                return sc.three           
            else:
                return sc
        except :
            pass
    def Repairc8c2(self,d0,v=0.7):
        d1=106
        value=v
            ...
            for i in range(0,5*d0-9):
                ...
                while current:                                  
                    if current.type=='s' and current.status==-1 and current.value!=0:
                        ...
                        self.SCRepair(current,value)
                        self.CheckSCNei(current)
                        newnode = self.SCNet(current)
                        self.SCRepair(newnode,value)
                        self.CheckSCNei(newnode)
                    current = current.next
                    ind+=1
