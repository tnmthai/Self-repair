...
### Damge case 2: 1 d-cell damage
    ...
    def SendMsgdc(self,node):
        try:
            ...
            node.next.status=-1
            node.next.value +=node.next.value*0.2



            node.up.status=-1
            node.up.value +=node.up.value*0.2

            node.down.status=-1
            node.down.value +=node.down.value*0.2
            node.prev.status=-1
            node.prev.value +=node.prev.value*0.2
        except :
            pass
...
#--------------------------------------------------------------------------------
    ...
    def Case3(self,position=0):# remove 5 d-cells
